...
public class FiltersSettings {
    ...
    private static ThemedIconCheckbox createReqDifficultyButton(String difficulty) {
        ...
        checkbox.addMouseListener(new MouseAdapter() {
            ...
            public void mouseReleased(MouseEvent e) {
                ...
                Settings.writeSettings("reqDifficultyFilter", excludedRequestedDifficulties.toString());
            }
        });
        return checkbox;
    }
    ...
    public static void loadDifficultiesAndLengths() {
        String excludedReqDifficultiesString = Settings.getSettings("reqDifficultyFilter").asString();
