...
public class VideoButton extends CurvedButtonAlt {
	...
	public VideoButton(YouTubeVideo data) {
		...
		JLabel thumbnail = new JLabel(new ImageIcon(new ImageIcon(VideoDetails.imageDownloader(data.getThumbnailURL())).getImage().getScaledInstance(160, 90, Image.SCALE_SMOOTH)));
